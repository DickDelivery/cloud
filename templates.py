...
templates = [
    {
        ...
        "text": "На ваше имя оформлен заказ: половой, {product_name}. Доставка осуществляется непосредственно в личные сообщения.Примите и распишитесь. С уважением, почтовая интернет-служба",
